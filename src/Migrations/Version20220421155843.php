 ...
 */
final class Version20220421155843 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE users_offres (user_id INT NOT NULL, offre_id INT NOT NULL, INDEX IDX_C94BBBD4A76ED395 (user_id), INDEX IDX_C94BBBD44CC8505A (offre_id), PRIMARY KEY(user_id, offre_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE users_offres ADD CONSTRAINT FK_C94BBBD4A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE users_offres ADD CONSTRAINT FK_C94BBBD44CC8505A FOREIGN KEY (offre_id) REFERENCES offre (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE users_offres');
